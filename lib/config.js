...
var config_path = process.env.SAUCELABS_JSON || 'saucelabs.json';
...
try {
  ...
  if (e.code === 'MODULE_NOT_FOUND') {
    logger.info('Configuration file `saucelabs.json` is missing.');
  } else {
    logger.info('Invalid configuration in `saucelabs.json` file');
